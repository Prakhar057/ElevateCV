      ...
      <div className="flex items-center gap-2">
        <label>
          {data.image ? (
            <img
              ...
              alt="user-image"
              className="w-16 h-16 rounded-full object-cover mt-5 ring ring-gray-600 hover:opacity-80"
            ></img>
          ) : (
            <div className=" inline-flex items-center gap-2 mt-5 text-gray-300 hover:text-white cursor-pointer">
        ...
        {typeof data.image === "object" && (
          <div className="flex flex-col gap-1 pl-4 text-sm">
            ...
            <label className="relative inline-flex items-center cursor-pointer text-gray-300 gap-3">
              <input
                type="checkbox"
              ...
              />
              <div className="w-9 h-5 bg-gray-600 rounded-full peer peer-checked:bg-blue-600 transition-colors duration-200"></div>
