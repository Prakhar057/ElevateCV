            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  type="month"
                  className="px-3 py-2 text-sm bg-gray-900 border border-gray-700 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors [color-scheme:dark]"
                />
              </div>
